...
aspect_ratio = 'square'
filenames = [r"D:\Univerzita\Numerické metody\Radial_problem\Task 3\interpolation_ground_state_difference.txt"]
x_column = 1
y_columns = [2]
show_legend = True
graph_title = r'Natural spline interpolation'
legend_title = 0
legend_frame = False
white = False
...
Y_axis = r'$\Delta E_0\,(\mathrm{a.u.})$ between spline and exact potential'
legends = [[0]]
labels = [[0]]
labels_position = [[(0,0)]]
colors = [['green']]
